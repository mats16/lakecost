...
export const ja: Dictionary = {
  ...
  pricing: {
    ...
    catalogMissingDesc:
      '価格表 Notebook を作成する前に、システム管理で FinLake カタログを設定してください。',
    provider: 'Provider',
    service: 'Service',
    slug: 'Slug',
    catalog: 'カタログ',
    ...
    notCreated: '未作成',
    detailsTitle: '価格表データ',
    createNotebook: 'Notebook を作成',
    updateNotebook: 'Notebook を更新',
    runNotebook: '実行',
    runFailed: 'Notebook 実行に失敗しました',
    runStarted: 'Notebook 実行を開始しました',
    runStartedWithId: 'Run #{runId} を送信しました。',
    setupFailed: 'Notebook セットアップに失敗しました',
    setupWarning: 'Notebook セットアップの警告',
    setupReady: 'Notebook を準備しました',
    notebookUploaded: 'Notebook を {path} にアップロードしました。',
    columns: {
      name: 'Name',
      table: 'Table',
      notebook: 'Notebook',
