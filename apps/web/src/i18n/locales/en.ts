export const en = {
  ...
  pricing: {
    ...
    catalogMissingDesc:
      'Configure the FinLake catalog from Admin before creating the pricing notebook.',
    provider: 'Provider',
    service: 'Service',
    slug: 'Slug',
    catalog: 'Catalog',
    ...
    runNotebook: 'Run',
    runFailed: 'Notebook run failed',
    runStarted: 'Notebook run started',
    runStartedWithId: 'Run #{runId} submitted.',
    setupFailed: 'Notebook setup failed',
    setupWarning: 'Notebook setup warning',
    setupReady: 'Notebook ready',
    notebookUploaded: 'Uploaded notebook to {path}.',
    columns: {
      name: 'Name',
      table: 'Table',
      notebook: 'Notebook',
